...
if ($format === 'excel') {
    // Output headers for Excel download (.xls format via HTML table)
    header("Content-Type: application/vnd.ms-excel");
    $filename = $dataset === 'audit' ? 'ECG_Ashanti_West_Audit_Trail_' : 'ECG_Ashanti_West_ICT_Requests_';
...
<body>
    ...
    <h4>ASHANTI WEST REGION - ICT DIRECTORATE <?php echo $report_title; ?></h4>
